...
p_node new_list_head=NULL;
p_node reverse(p_node head)
{
    p_node new_list_first_node = NULL;
    while(head->next)
    {
        new_list_first_node = head->next; 
        head->next = head->next->next;
        new_list_first_node->next = new_list_head->next;
        new_list_head->next = new_list_first_node;
    }
...
int main()
{
    ...
    head_node->next = NULL;
    new_list_head = (p_node)malloc(sizeof(t_node));
